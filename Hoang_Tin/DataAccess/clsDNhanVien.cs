...
namespace Hoang_Tin.DataAccess
{
    public class clsDNhanVien : clsDBase
    {
        ...
        public DataTable SELECT_NHANVIEN_BY_ID()
        {
            DataTable returnValue = new DataTable();
            OpenConnection();
            sqlCommand.CommandText = "SELECT * FROM [tblNHANVIEN] WHERE MaNV=@MaNV";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
        ...
        public DataTable SELECT_NHANVIEN_LOGIN_INFO()
        {
            DataTable returnValue = new DataTable();
            OpenConnection();
            sqlCommand.CommandText = "Select MatKhau,TenNV from tblNhanvien where MaNV=@MaNV";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
                sqlCommand.Parameters.Add("@MaNV", SqlDbType.VarChar, 50).Value = MaNV;
        ...
        public int UPDATE_NHANVIEN()
        {
            int affectedRow = 0;
            OpenConnection();
            sqlCommand.CommandText = "UPDATE [tblNHANVIEN] SET MatKhau=@MatKhau,TenNV=@TenNV,NgaySinh='" + NgaySinh.ToShortDateString() + "',Diachi=@Diachi,Dienthoai=@Dienthoai,laAdmin=@laAdmin WHERE MaNV=@MaNV";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
        ...
        public int DELETE_NHANVIEN()
        {
            int affectedRows = 0;
            OpenConnection();
            sqlCommand.CommandText = "DELETE FROM [tblNHANVIEN] WHERE MaNV=@MaNV";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
                sqlCommand.Parameters.Add("@MaNV", SqlDbType.VarChar, 50).Value = MaNV;
        ...
        public int INSERT_NHANVIEN()
        {
            int affectedRows = 0;
            OpenConnection();
            sqlCommand.CommandText = "INSERT INTO [tblNHANVIEN](MaNV,[MatKhau],TenNV,NgaySinh,Diachi,Dienthoai,laAdmin,LoaiNhanVienID) VALUES(@MaNV,@MatKhau,@TenNV,'" + NgaySinh.ToShortDateString() + "',@Diachi,@Dienthoai,@laAdmin)";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
                sqlCommand.Parameters.Add("@MaNV", SqlDbType.VarChar, 50).Value = MaNV;
        ...
        public DataTable DANG_NHAP()
        {
            DataTable returnValue = new DataTable();
            OpenConnection();
            sqlCommand.CommandText = "SELECT * FROM [tblNHANVIEN] WHERE MaNV=@MaNV AND MatKhau=@MatKhau";
            sqlCommand.CommandType = CommandType.Text;
            try
            {
                sqlCommand.Parameters.Add("@MaNV", SqlDbType.VarChar, 50).Value = MaNV;
